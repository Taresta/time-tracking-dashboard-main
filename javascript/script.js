...
function populateDOM(activityData, timeframe = "daily") {
    ...
    const cardsContainer = document.querySelector('.time-trackig-cards-container');
    ...
    for (const activity of activityData) {
        ...
        currentTime.textContent = activity.timeframes[timeframe].current;

        if (timeframe === "daily") {
            previousTime.textContent = `Yesterday - ${activity.timeframes[timeframe].previous}`;
        }
       else if (timeframe === "weekly") {
        previousTime.textContent = `Last Week - ${activity.timeframes[timeframe].previous}`;
       }
       else if (timeframe == "monthly") {
        previousTime.textContent = `Last Month - ${activity.timeframes[timeframe].previous}`;
       }
    ...
    //If I use the already created article elements then select them as query selector all, and then loop theough this
    //I can use the data attributes for creating the appropriate data for each article
