...
function handleButtonStyle(e) {
    buttonList.forEach(button => {
        button.classList.remove('active'); //Remove styles from the previously clicked buttons
        e.target.classList.add('active'); //Add style to the newly clicked button
    });
}
function populateDOM(activityData, timeframe = "daily") {
    ...
    //Then we would loop through the data array
    for (const activity of activityData) {
        ...
        //Add classes to the above created elements
